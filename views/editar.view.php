...
<h3 class="center"><i class="fa fa-user-md"> </i> Editar Nuevos usuarios</h3>
<hr class="alt1"><br>
<form class="form" action="editar.php" method="post">
<input type="hidden" name="id" value="<?php echo $post->id; ?>">
	<div class="column col_4">
		<label for="text1"><i>D.N.I :</i></label>
	    <input id="text1" type="text" name="dni" value="<?php echo $post->dni; ?>" />
  	</div>
  	<div class="col_4">
	    <label for="text2"><i>NOMBRE :</i></label>
	    <input id="text2" type="text" name="nombre" value="<?php echo $post->nombre; ?>" />
	</div>
	<div class="col_4">
	    <label for="text3"><i>APELLIDO :</i></label>
	    <input id="text3" type="text" name="apellido" value=" <?php echo $post->apellido; ?>" />
    </div>

    <div class="col_4">
	    <label for="text4"><i>CORREO :</i></label>
	    <input id="text4" type="text" name="correo" value="<?php echo $post->correo ?>" />
	</div>

	<div class="col_4">
	    <label for="text5"><i>PAIS :</i></label>
	    <input id="text5" type="text" name="pais" value="<?php echo $post->pais; ?>" />
	</div>    
<div class="col_12">
